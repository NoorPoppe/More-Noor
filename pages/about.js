        ...
        <div>
            <article>
                ...
                <section className={styles.header}>
                    <div>
                        <h2 className={styles.title} ><Image src="/gif/Hi.gif" width={145} height={196} alt="Hello" /><Image src="/hello-hand.gif" width={213} height={160} alt="Hello" /> Nice to meet you!</h2>
